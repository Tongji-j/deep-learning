...
def run_training():
    ...
    poems_vector, word_to_int, vocabularies = process_poems1(r'C:\Users\33552\Desktop\神经网络与深度学习\exercise-master\exercise-master\chap6_RNN\tangshi_for_pytorch\poems.txt')
    # 生成batch
